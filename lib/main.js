...
const requestManager = require('./processing/requestManager');
...
class main {
  ...
  _initModules() {
    ...
    this._requestManager = new requestManager(this._config.requestManager, this._factory);
    this._factory.setInstance('requestManager', this._requestManager);
